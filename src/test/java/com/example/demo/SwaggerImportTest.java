...
public class SwaggerImportTest {
    ...
    private final String swaggerUrl = "http://localhost:8084/budgetctl/v2/api-docs";
    ...
    public void generateAsciiDocs() throws Exception {
        ...
        Swagger2MarkupConfig config = new Swagger2MarkupConfigBuilder()
                .withMarkupLanguage(MarkupLanguage.ASCIIDOC) //可以切换为 MARKDOWN 生成 .md文件
    ...
    public void generateConfluenceDocs() throws Exception {
        ...
        Swagger2MarkupConverter.from(new URL(swaggerUrl))
                .withConfig(config)
                .build()
                .toFolder(Paths.get("src/docs/generated/confluence"));
    }
